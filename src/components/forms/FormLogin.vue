<template>
    <div>
        ...
        <div class="w-full centraliza-div max-w-sm p-4 border-t-4 border-t-emerald-800 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <form class="space-y-6" @submit.prevent>
                        ...
                        <div class="flex items-start">
                            <a href="#" v-on:click="openModal()" class="ms-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Recuperar Senha?</a>
                        </div>
        ...
        <FormRecoveryPasswodSend v-show="open_modal" @close="open_modal = false"/>
...
import FormRecoveryPasswodSend from './FormRecoveryPasswodSend.vue'
...
export default defineComponent({
    name: 'FormLogin',
    components: {
        HomePage, FormRecoveryPasswodSend
    },
    data(){
        return{
            open_modal: false
